...
module.exports = {
  ...
  magento: {
    url: process.env.MAGENTO_URL || 'http://localhost/mac/rest',
    consumerKey: process.env.MAGENTO_CONSUMER_KEY || 'vfninxjk5xrlwhbnsp74bcan8xie4sjy',
    consumerSecret: process.env.MAGENTO_CONSUMER_SECRET || 'z0snfc1st287q2b10ddd8pkupa1rlt2t',
    accessToken: process.env.MAGENTO_ACCESS_TOKEN || 'owugtz6r8k0yfuu7agarpwvydyffd4z1',
    accessTokenSecret: process.env.MAGENTO_ACCESS_TOKEN_SECRET || 'xgdvukaou23xk9ypfhxwy4n9gbzgt8rs',
